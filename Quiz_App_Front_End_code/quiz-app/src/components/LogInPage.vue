<template>
  <div class="">
    <div
      ...
      <h1 class="mx-80 font-bold text-green-600 text-3xl font-sans mb-4 md:mx-96  lg:ml-[48vw] lg:-mt-20">Quiz<span
      ...
      <div
        ...
        <div class="form flex flex-col space-y-8">
          ...
          <input
            class="h-12 w-64  px-10 rounded-sm bg-[#f3f7f7] border-2 border-[#f3f7f7] hover:focus cursor-pointer md:w-[60vw]"
            type="password" v-model="password" name="" id="" placeholder="Your password">
        </div>
        <div class="button">
        ...
        <div class="register flex ">
          ...
          <a href="#" class="text-green-700 font-bold ">
            <router-link to="/" exact>Register here</router-link>
          </a>
        </div>
      </div>
    </div>
